...
For a complete list of {{site.data.keyword.Bluemix_notm}} commands, see: [{{site.data.keyword.Bluemix_notm}} (bx) commands](docs/cli/reference/bluemix_cli/get_started.html#getting-started)
